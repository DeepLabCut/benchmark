...
class DLCTriMouse(DLCBenchMixin, TriMouseBenchmark):
    ...
    _filenames = {
        "EfficientNet B7 (30K)": "data/DLC_effnet_b7_MultiMouseJun22shuffle1_30000-snapshot-30000_assemblies.pickle",
        "DLCRNet_ms5 (30K)": "data/DLC_dlcrnetms5_MultiMouseJun22shuffle1_30000-snapshot-30000_assemblies.pickle",
...
class MaDLCParentingMouse(DLCBenchMixin, ParentingMouseBenchmark):
    ...
    _filenames = {
        ...
        "DLCRNet_ms5 (30k)": "data/DLC_dlcrnetms5_CrackingParentingMar24shuffle1_30000-snapshot-30000_assemblies.pickle",
    }
...
class MaDLCMarmosetBenchmark(DLCBenchMixin, MarmosetBenchmark):
    ...
    _filenames = {
        ...
        "DLCRNet_ms5 (200k)": "data/DLC_dlcrnetms5_MarmosetMay7shuffle1_200000-snapshot-200000_assemblies.pickle",
        "DLCRNet_ms5_s4 (200k)": "data/DLC_dlcrnetms5_s4_MarmosetMay7shuffle1_200000-snapshot-200000_assemblies.pickle",
    }
...
class MaDLCFishBenchmark(DLCBenchMixin, FishBenchmark):
    ...
    _filenames = {
        "EfficientNet B7 (30K)": "data/DLC_effnet_b7_SchoolingMay7shuffle1_30000-snapshot-30000_assemblies.pickle",
        "ResNet50 (30K)": "data/DLC_resnet50_SchoolingMay7shuffle1_30000-snapshot-30000_assemblies.pickle",
        "DLCRNet_ms5 (30k)": "data/DLC_dlcrnetms5_SchoolingMay7shuffle1_30000-snapshot-30000_assemblies.pickle",
    }
